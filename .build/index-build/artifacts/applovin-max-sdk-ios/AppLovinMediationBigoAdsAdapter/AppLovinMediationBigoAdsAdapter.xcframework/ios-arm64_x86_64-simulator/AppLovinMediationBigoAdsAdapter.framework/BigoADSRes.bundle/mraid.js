...
(function() {
  ...
  mraid.getState = function() {
    bridge.executeNativeCall(['invoke', 'getState', state]);
    return state;
  };

  mraid.isViewable = function() {
    bridge.executeNativeCall(['invoke', 'isViewable', isViewable]);
    return isViewable;
  };

  mraid.getVersion = function() {
    bridge.executeNativeCall(['invoke', 'getVersion', MRAID_ENV.version]);
  ...
  mraid.supports = function(feature) {
    bridge.executeNativeCall(['invoke', 'supports', feature]);
